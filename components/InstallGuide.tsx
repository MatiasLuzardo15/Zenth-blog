...
const InstallGuide: React.FC = () => {
  return (
    <section id="install" className="py-24 bg-zenth-100 dark:bg-slate-800 relative overflow-hidden border-t-4 border-black dark:border-white border-dashed">
      ...
      {/* Background Doodles */}
      <div className="absolute top-10 right-10 w-32 h-32 border-4 border-black dark:border-white rounded-full opacity-10"></div>
      <div className="absolute bottom-10 left-10 w-20 h-20 border-4 border-black dark:border-white opacity-10 transform rotate-45"></div>
